        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackAmount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoffeeAmounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoffeeAmounts_Amounts_AmountId",
                        column: x => x.AmountId,
                        principalTable: "Amounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CoffeeAmounts_Coffees_CoffeeId",
                        column: x => x.CoffeeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CoffeeAmountId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderLines_CoffeeAmounts_CoffeeAmountId",
                        column: x => x.CoffeeAmountId,
                        principalTable: "CoffeeAmounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoffeeAmounts_AmountId",
                table: "CoffeeAmounts",
                column: "AmountId");

            migrationBuilder.CreateIndex(
                name: "IX_CoffeeAmounts_CoffeeId",
                table: "CoffeeAmounts",
                column: "CoffeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderLines_CoffeeAmountId",
                table: "OrderLines",
                column: "CoffeeAmountId");
